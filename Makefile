...
#
# For standard installation of django-json-dbindex, see INSTALL.
# For details about django-json-dbindex's development environment, see CONTRIBUTING.rst.
#
PIP = pip
TOX = tox
PROJECT = $(shell python -c "import setup; print setup.NAME")
DEMO = django-json-dbindex-demo
